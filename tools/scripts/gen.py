...
struct_bytes[26]  = 0x12   # motor_kv. Default to 0x37 = 55 => 2220kv. 0x12 => 780kv
struct_bytes[27]  = 0x0C    # motor_poles. Default to 0x0E = 14. 0x0C => 12 poles
struct_bytes[28]  = 0x01     # brake_on_stop. Default to 0
struct_bytes[29]  = 0x00     # stall_protection. Default to 0
struct_bytes[30]  = 0x09    # beep_volume. Default to 0x05 = 5
struct_bytes[31]  = 0x00     # telemetry_on_interval. Default to 0x00 = 0

# --- Servo Configuration (Indices 32 - 35) ---
struct_bytes[32]  = 0x88   # servo.low_threshold. Default to 0x80 = 128 => 1006
...
struct_bytes[35]  = 0x14     # servo.dead_band. Default to 0x32 = 50. 0x19 => 20

# --- Additional Protections & Logic (Indices 36 - 42) ---
# One of the reason why the motor is not running is because the low voltage cutoff is set and the measured
#   voltage is wrongly below the cutoff. Have to test and set the voltage divider
struct_bytes[36]  = 0xFF     # low_voltage_cut_off. Default to 0x00 = 0. 0xff to disable
# One of the reason why the motor is not running is because the low voltage cutoff is set and the measured
#   voltage is wrongly below the cutoff. Have to test and set the voltage divider
struct_bytes[37]  = 0x00     # low_cell_volt_cutoff. Default to 0x32 = 50 (2.5V per cell). 0x00 to disable
# RC CAR REVERSE make my PWM gen not working
struct_bytes[38]  = 0x00     # rc_car_reverse. Default to 0x00 = 0
struct_bytes[39]  = 0x00     # use_hall_sensors. Default to 0x00 = 0
struct_bytes[40]  = 0x05    # sine_mode_changeover_thottle_level. Default to 0x0F = 15
...
struct_bytes[45]  = 0x05    # sine_mode_power. Default to 0x06 = 6
